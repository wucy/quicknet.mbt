...
const char* qnsfwd_rcsid = 
    "$Header: /u/drspeech/repos/quicknet2/qnsfwd.cc,v 1.67 2011/09/06 22:12:06 davidj Exp $";
#endif
...
//				   outlayer_type, mlp3_bunch_size);
	...
	{
	    //cz277 - dnn - useless
	    const size_t a_layer_units[3] = {n_input, n_hidden, n_output};	    
	    mlp3 = new QN_MLP_ThreadFl3(debug, "fwdmlp",
                                        a_layer_units, outlayer_type,
...
// Open files and provisionally check arguments.
    ...
    {
	struct MapStruct *mapclass;	//cz277 - outmap
