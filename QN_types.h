// $Header: /u/drspeech/repos/quicknet2/QN_types.h,v 1.35 2011/08/16 19:42:30 davidj Exp $
...
enum QN_SectionSelector
{
    ...
    QN_LAYER910_WEIGHTS,
    QN_LAYER10_BIAS,
    QN_LAYER1011_WEIGHTS,
    QN_LAYER11_BIAS,
    QN_LAYER1112_WEIGHTS,
    QN_LAYER12_BIAS,
    QN_LAYER1213_WEIGHTS,
    QN_LAYER13_BIAS,
    QN_LAYER1314_WEIGHTS,
    QN_LAYER14_BIAS,
    QN_LAYER1415_WEIGHTS,
    QN_LAYER15_BIAS,
    QN_LAYER1516_WEIGHTS,
    QN_LAYER16_BIAS,
    QN_LAYER1617_WEIGHTS,
    QN_LAYER17_BIAS,
    QN_LAYER1718_WEIGHTS,
    QN_LAYER18_BIAS,
    QN_LAYER1819_WEIGHTS,
    QN_LAYER19_BIAS,
    QN_LAYER1920_WEIGHTS,
    QN_LAYER20_BIAS,
    QN_WEIGHTS_UNKNOWN,
    QN_WEIGHTS_NONE = QN_WEIGHTS_UNKNOWN
};
...
enum QN_LayerType {
    ...
    QN_LAYER_SOFTMAX,
    QN_LAYER_TANH,
    QN_LAYER_SOFTSIGN,	//cz277 - nonlinearity
    QN_LAYER_SIGMOID_XENTROPY        //cz277 - nonlinearity, should be removed, kept to make other MLPs compatible
};
...
enum QN_OutputLayerType {
    ...
    QN_OUTPUT_SOFTSIGN = QN_LAYER_SOFTSIGN,	//cz277 - nonlinearity
    QN_OUTPUT_SIGMOID_XENTROPY = QN_LAYER_SIGMOID_XENTROPY   //cz277 - nonlinearity, should be removed, kept to make other MLPs compatible
};

//cz277 - criteria
enum QN_CriterionType {
    QN_CRITERION_QUADRATIC,
    QN_CRITERION_XENTROPY
};

//cz277 - rand init
enum QN_RandomInitType {
    QN_RANDINIT_NORMAL,
    QN_RANDINIT_NORMALIZED
};
...
// The types of stream padding.
enum QN_PadType {
    QN_PAD_ZERO,		// Zero padding
    QN_PAD_REPEAT		// Repeat first/last frame
};
