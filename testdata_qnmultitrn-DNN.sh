...
${qnmultitrn:=./qnmultitrn} \
	...
	learnrate_schedule=${learnrate_schedule:=list} \
	learnrate_listfile=${learnrate_listfile:=list2.list} \
	...
	mlp_size=${mlp_size:=153,100,100,100,100,100,100,100,100,100,56} \
	#mlp_size=${mlp_size:=153,1100,,56} \
