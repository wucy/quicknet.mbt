const char* QN_MLP_ThreadFl3_rcsid =
    "$Header: /u/drspeech/repos/quicknet2/QN_MLP_ThreadFl3.cc,v 1.12 2011/08/16 19:39:17 davidj Exp $";
...
QN_MLP_ThreadFl3::forward_bunch(size_t n_frames, const float* in, float* out,
    const float * * wgt, const size_t nn)
{
