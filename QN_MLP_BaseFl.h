...
public:
    ...
    //cz277 - momentum
    void set_alpha_momentum(float a_alpha_momentum) { this->alpha_momentum = a_alpha_momentum; };
    //cz277 - weight decay
    void set_weight_decay_factor(float weight_decay_factor) { this->weight_decay_factor = weight_decay_factor; };
...
protected:
    ...
    //cz277 - momentum
    float *weights_delta[MAX_WEIGHTMATS];
