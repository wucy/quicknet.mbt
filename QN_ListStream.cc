// $Header: /u/drspeech/repos/quicknet2/QN_ListStream.cc,v 1.6 2011/09/06 22:12:05 davidj Exp $
...
QN_SegID QN_InFtrStream_List::set_pos(size_t segno, size_t frameno) {
	...
	ret = 0;  // FIXME -- this is because QN_InLabStream_ILab::get_pos
	          // returns with zero.  Should return as above.
    }
    return ret;
}
