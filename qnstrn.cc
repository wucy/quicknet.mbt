...
const char* qnstrn_rcsid = 
    "$Header: /u/drspeech/repos/quicknet2/qnstrn.cc,v 1.67 2011/09/06 22:12:06 davidj Exp $";
#endif
...
//    unsigned long ckpt_seconds = (unsigned long) config.ckpt_hours;
	...
	struct MapStruct *mapclass = NULL;
	const char *lr_crt;
	trainer->train(lr_crt, mapclass);	//cz277 - outmap	//cz277 - learn rate criterion
	delete trainer;
    }
    else
    {
