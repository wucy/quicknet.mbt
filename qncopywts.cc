...
qncopywts(FILE* log_fp)
{
    ...
    QN_LayerType temp[1] = {QN_LAYER_TANH};
    mlp = new QN_MLP_BunchFlVar(-1, debug, "mlp", in_layers, in_layer_size,
				QN_CRITERION_XENTROPY, &temp[0],	//cz277 - criteria	//cz277 - nonlinearity, just to make the construction function happy
				layer_type, 1);
